...
from APP_Timbrage.identification.gestion_identification_wtf_forms import FormWTFAjouterCollaborateur
from APP_Timbrage.identification.gestion_identification_wtf_forms import FormWTFUpdateIdentification
from APP_Timbrage.identification.gestion_identification_wtf_forms import FromWTFDeleteIdentification
...
def identification_afficher(order_by, id_identification_sel):
    ...
    return render_template("identification/identification_afficher.html", data=data_identification)
...
def identification_ajouter_wtf():
    ...
    return render_template("identification/identifiaction_ajouter_wtf.html", form=form)
...
def identification_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            valeur_update_dictionnaire = {"value_id_identification": id_identification_update, "value_nom_utilisateur_identification": nom_utilisateur_identification_update, "value_courriel_identification": courriel_identification_update, "value_mdp_identification": mdp_identification_update}
            print("valeur_update_dictionnaire ", valeur_update_dictionnaire)

            str_sql_update_nom_utilisateur = """UPDATE t_identification SET nom_utilisateur = %(value_nom_utilisateur_identification)s, courriel = %(value_courriel_identification)s, mot_de_passe = %(value_mdp_identification)s WHERE id_identification = %(value_id_identification)s"""
            ...
            str_sql_id_identification = "SELECT id_identification, nom_utilisateur, courriel, mot_de_passe FROM t_identification WHERE id_identification = %(value_id_identification)s"
            ...
            print(" ", data_nom_utilisateur_identification_collaborateur, " type ", type(data_nom_utilisateur_identification_collaborateur), " nom_utilisateur ",
                  data_nom_utilisateur_identification_collaborateur["courriel"], data_nom_utilisateur_identification_collaborateur["mot_de_passe"])
    ...
    return render_template("identification/identification_update_wtf.html", form_update=form_update)
...
def identification_delete_wtf():
    ...
    return render_template("identification/identification_delete_wtf.html",
