...
class FormWTFUpdateIdentification(FlaskForm):
    ...
    mdp_identification_update_regexp = "^([A-Z]|[a-zÀ-ÖØ-öø-ÿ])[A-Za-zÀ-ÖØ-öø-ÿ]*['\- ]?[A-Za-zÀ-ÖØ-öø-ÿ]+$"
    mdp_identification_update_wtf = PasswordField("Mot de passe : ", validators=[Length(min=2, max=20, message="min 2 max 20"),
